...
def higher_card(card_one: str, card_two: str):
    ...
    3.  '2' - '10' = numerical value.
    """
    return (card_one, card_two) if CARD_VALUES[card_one] == CARD_VALUES[card_two] else card_one if CARD_VALUES[card_one] > CARD_VALUES[card_two] else card_two
...
def value_of_ace(card_one: str, card_two: str):
    ...
    if card_one == 'A' or card_two == 'A':
        return 1
    if CARD_VALUES[card_one] + CARD_VALUES[card_two] + 11 > 21:
        return 1
    return 11
...
def is_blackjack(card_one: str, card_two: str):
    ...
    3.  '2' - '10' = numerical value.
    """
    return (card_one != card_two and 'A' in (card_one, card_two) and (CARD_VALUES[card_one] == 10 or CARD_VALUES[card_two] == 10))
